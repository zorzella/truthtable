 ...
 */
public class FixedCoordinatesTest extends TestCase {

  public void testSimple() throws Exception {
    new FixedCoordinates(Entree.STEAK, Bread.PITA);
  }
  
  public void testDifferentDimensionsIsEnforced() throws Exception {
    try {
